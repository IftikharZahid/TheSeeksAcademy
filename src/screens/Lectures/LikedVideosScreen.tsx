...
// Preloading Skeleton Screen component for row-based video item
const SkeletonRowVideoCard: React.FC<{ theme: any; isDark: boolean }> = ({ theme, isDark }) => {
    const skeletonColor = isDark ? 'rgba(255, 255, 255, 0.08)' : 'rgba(0, 0, 0, 0.06)';
    return (
        <View style={[styles.videoItem, { backgroundColor: theme.card, borderColor: theme.border, elevation: 0 }]}>
            {/* Thumbnail placeholder */}
            <View style={[styles.thumbnailContainer, { backgroundColor: skeletonColor }]} />
            
            {/* Text details placeholder */}
            <View style={styles.videoInfo}>
                {/* Title line 1 */}
                <View style={{ width: '85%', height: scale(12), backgroundColor: skeletonColor, borderRadius: scale(3), marginBottom: scale(8) }} />
                {/* Title line 2 */}
                <View style={{ width: '60%', height: scale(12), backgroundColor: skeletonColor, borderRadius: scale(3), marginBottom: scale(8) }} />
                
                {/* Meta details */}
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: scale(8) }}>
                    <View style={{ width: scale(55), height: scale(10), backgroundColor: skeletonColor, borderRadius: scale(2) }} />
                    <View style={{ width: scale(30), height: scale(10), backgroundColor: skeletonColor, borderRadius: scale(2) }} />
                </View>
            </View>
            
            {/* Chevron placeholder */}
            <View style={{ width: scale(16), height: scale(16), backgroundColor: skeletonColor, borderRadius: scale(8), marginRight: scale(4) }} />
        </View>
    );
};
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={['top', 'left', 'right']}>
            ...
            {loading ? (
                <FlatList
                    data={[1, 2, 3, 4, 5]}
                    renderItem={() => <SkeletonRowVideoCard theme={theme} isDark={isDark} />}
