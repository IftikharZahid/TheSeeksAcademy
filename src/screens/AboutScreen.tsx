        ...
        <View style={styles.section}>
          ...
          <View style={[styles.card, { backgroundColor: theme.card }]}>
            ...
            <View style={styles.socialLinks}>
              ...
              <TouchableOpacity style={styles.socialBtn} onPress={() => handleLinkPress('mailto:iftikharxahhid@gmail.com')}>
                <Text style={styles.socialIcon}>📧</Text>
                <Text style={[styles.socialText, { color: theme.text }]}>Email</Text>
              </TouchableOpacity>
